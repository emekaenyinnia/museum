...
<table class="table table-striped"id="myTable" style="color: #fff;">
    ...
    <tbody>
      <tr>
        ...
        <td><a href="edit?gallery=<?php echo $galleryRow['gallery_id'];?>"class="btn btn-success">Manage</a><br><br><a href="delete?gallery=<?php echo $galleryRow['gallery_id'];?>"class="btn btn-danger">Delete</a></td>
      </tr>
