...
$add = mysqli_query($conn, "INSERT INTO tbl_users (email,password,origin,firstname,surname,phone,type,status) values('$email','$password','$origin','$firstname','$surname','$phone','visitor','active')");
